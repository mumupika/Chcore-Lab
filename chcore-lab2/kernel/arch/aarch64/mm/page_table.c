...
int query_in_pgtbl(void *pgtbl, vaddr_t va, paddr_t *pa, pte_t **entry)
{
        ...
        {
                /**
                 * bit 47-30 is the l1_block pfn.
                 * bit 29-0 is the block_shift, which is get by mask.
                 */
        ...
        {
                /**
                 * bit 47-21 is the l1_block pfn.
                 * bit 20-0 is the block_shift, which is get by mask.
                 */
